...
class CarouselView extends StatefulWidget {
  ...
  /// The [CarouselView] shows pagination on state true.
  ...
  /// The initial page to show when first creating the [CarouselView]. Defaults to 0.
...
class _CarouselViewState extends State<CarouselView> with TickerProviderStateMixin {
  Timer? timer;
