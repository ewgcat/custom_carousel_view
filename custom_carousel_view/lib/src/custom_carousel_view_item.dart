...
/// touched the surface.
typedef CarouselViewItemSlideStartCallback = void Function(
...
typedef CarouselViewItemSlideCallback = void Function(DragUpdateDetails details);
...
/// the screen.
typedef CarouselViewItemSlideEndCallback = void Function(DragEndDetails details);

class CarouselViewItem extends StatefulWidget {
  ...
  final CarouselViewItemSlideStartCallback? onSlideStart;

  /// When a pointer that is in contact with the screen and moving
  /// has moved again.
  final CarouselViewItemSlideCallback? onSlide;

  /// When a pointer that was previously in contact with the screen
  /// and moving is no longer in contact with the screen.
  final CarouselViewItemSlideEndCallback? onSlideEnd;

  /// defines the height of items
  final double itemHeight;

  @override
  _CarouselViewItemState createState() => _CarouselViewItemState();
}

class _CarouselViewItemState extends State<CarouselViewItem>
